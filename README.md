...
- Dos juegos con el mismo motor: `dist/cauces.html` (los grandes ríos) y `dist/exploradores.html` (los grandes viajes,
  etapa por etapa: Ibn Battuta, Marco Polo, Zheng He, Odiseo, Humboldt, James Cook, Alejandro Magno, Hernán Cortés y
  Napoleón, cada uno con su caravana, flota o ejército, un animal de guía, una carga de trueque y una línea de tiempo bajo el mapa). En los viajes la memoria es
...
- Dos ediciones de cada juego, del mismo código: la económica (`cauces.html`, `exploradores.html`), de menos de medio
  ...
  el globo; también la embarcación de cada ruta, pintada igual, en «Tu embarcación», y, de prueba, las mercancías del Nilo en su mercado
  y las postales del Tigris, que pintan la imagen para recordar de cada ciudad. Antes, del 2026-09-17 al 23, fueron vectores sobre siluetas de [PhyloPic](https://www.phylopic.org) de dominio público o CC0
