...
ECO=set(json.loads(subprocess.run(['node'],input=RUTAS.cortar(src('rios.js'),'economica')+';console.log(JSON.stringify(RIVERS.map(r=>r.id)))',capture_output=True,text=True,encoding='utf8').stdout))  # ríos de la edición económica; los demás solo van en la amplia
...
DUDAS=['5 464','4 500 m','más de veinte veces','1887','226 días','diez metros','Zhongshan','1909','Bayan Obo','lugar de ciervos','3 500 años','1938','960-1127','72 famosos','1855','1983','Shengli','Trece pieles','siglo XI','999 días','millones de vidas','722 m','quince kilómetros','800 km','acampó Stanley','más agua que por ninguna','Chambeshi','1 400 m','200 m en algunos','Eala','Upemba','Yelala','Rabona','ocho caballos','doce mil','documento de la familia','170 hombres','miles de carretas','unos 40 000','30 000 km','más de 150 000','cuatro o cinco pisos','diez días','harina','Coleridge','nadie los reconoció','Kubla','sagú','unicornio','Chen Zuyi','indemnización','Bayalun','clavija','veinte mujeres','Villa Rica','1978','más de un millón','Rihla','120 000','madre de ciudades','1258','Abu Said','mejor construidas','Bayalun','Santa Sofía','Tughluq','1341','cauri','Zaitún','juncos','Tagaza','Sulaymán','1355','24 años','Calicut','peste','Niamey','segunda muralla','capitales más cercanas','torre de iglesia','exportador','tamaño de Costa Rica','3 700 km','14 m','cuarto del PIB','60 %','80 %','mercado de algodón','molinos de Budapest','Kamyshin','granero que alimentaba','Inn trae','tejedores','40 castillos','400 millones','Pataliputra','Ilısu','más peligrosa','once presas','mitad del arroz','700 km','90 %','Yacyretá (1994)','3 400 km','tercio de Pakistán','20 millones','66 compuertas','1583','3 500 m','tamaño de Suiza','COP30','2025','Kumbh','más de 100 TWh','1,3 millones','primera gran manufactura','Ver-o-Peso','almacén enorme','tarta más antigua','30 millones','cien camiones','mil camiones','50 kilos','Ergani','lustre','Marajó','144 km','145 km','84 km','192 km','780 m','mundial de 1998','250 m','100 kilos','nueve de cada diez','Cariblanco','años ochenta','más antigua del país','segunda puerta','1833','más lluviosos','miles de patos','Muelle','puerto fluvial','1769','Sardinal','1854','canal que nunca','reconstruido','Solentiname','desde 1942','Guayabo','clase III','4 000 mm','Puente','cacao que sirvió','Ujarrás','Casa del Soñador','Hacienda Juan Viñas','fines de comercio','2015 y 2018','cancelada en 2024','Isla Portillos','1957','70 000','1817','80 km','Kumbh','Repin','Cai Rang','harmatán','sudestada','quinta parte','diez países','111 km','160 km','1958','Intel','1997','Los Tajos','1910','puente de Mulas','balsa','huetares','Fortín','1876','Chirripó','3 820','1979','Del Monte','1938','Finca 6','2014','Diquís','2018','Diablitos','30 de diciembre','esferas','mil años','manglar','siglos IV y XVI','agua grande','primera exportación','más contaminado']
DUDAS+=['1951','segundo caudal','1928','1924','Samariapo','sarrapia','petroglifos','menos de un kilómetro','1824','1,7 km','cientos de caños','300 km','2 228','40 %','Ponde','1830','1887','Hovell','1865','1866','se juntan las aguas','1836','tierra roja','1879','1886','Mobilong','1854','1853','número 11','2002','74 m','quinta parte','3 000 km','3 700 km','225 m','1841','1832','Pueblos Perdidos','1825','1634','papel de periódico','1608','amurallada','1759','1600','20 km','68 m','siete esclusas','La Salle','puente de hielo','1 500 m','cuarto río','Sofala','1858','apagar el fuego','Kazungula','108 m','1905','220 km','6 000','1973','1891','1923','1958','Idai','Kuomboka']  # ríos de la edición amplia (2026-09-13)
DUDAS+=['861','seis kilómetros','1 200 km','siglo VII','29 esclusas','más largo que el propio','puerto interior más grande','2009','unos pocos miles','28 m','años 1990','Lan Xang','siglo XIV','unos cientos','1994','2011','326 a. C.','Babur','dos veces','10 m','seis ciudades']  # eventos de la edición amplia (2026-09-13)
...
for r in R:
    out+= [f"## {r['nombre']} ({r['longitud']:,} km hasta {r['marEn']})".replace(',',' ')+('' if r['id'] in ECO else ' · solo en la edición amplia'),""]
    def add(etq,t):
