...
setTimeout(()=>{
  ...
  if((edicion==='amplia')!==(typeof RETRATOS!=='undefined'))throw 'RETRATOS en la edición '+edicion;if(edicion==='amplia'&&juego==='cauces'&&!(RETRATOS.hipo&&RETRATOS.hipo.o))throw 'sin retrato del hipopótamo';
