...
const JUEGO={id:'cauces',nombre:'Cauces',sub:'Los grandes ríos, ciudad por ciudad',tipo:'rio',clave:'cauces',
  ...
  grupos:[{titulo:'Los grandes ríos',filtro:r=>!r.zona,porRegion:true,antes:'<div class="frase"><div class="fkicker">Podio por longitud</div><div class="ftexto"><b>No</b> <b>Am</b>es <b>Ya</b> <b>M</b>ás</div><div class="fnota">Nilo, Amazonas, Yangtsé, Misisipi: los cuatro más largos, en orden.</div></div>'},
